...
export function TeamCard({cards}) {
      ...
      {cards.map((card, index) => (
        <motion.div
          ...
          <motion.button
            ...
            className="px-4 py-2 text-sm rounded-full font-bold bg-[--primary] hover:bg-green-500 hover:text-white text-white mt-4 md:mt-0">
            {card.ctaText}
          </motion.button>
        </motion.div>
      ))}
